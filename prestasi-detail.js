...
function populatePrestasiSelects() {
    ...
    const kegiatanSelect = document.getElementById('prestasi-kegiatan');
    ...
    if (kegiatanSelect) {
        const current = kegiatanSelect.value;
        kegiatanSelect.innerHTML = '<option value="">Pilih Nama Kegiatan</option>' +
